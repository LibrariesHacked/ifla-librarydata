            ...
            $.each(results.meta.fields, function (i, header) { // For each field
                ...
                if (lib_type !== '') {
                    ...
                    $('div[data-content="' + lib_type_index + '"]').append(
                        '<div class="div-input"><input id="chb-' + measure + '" class="switcher is-checkradio is-circle is-success" type="checkbox" ' + checked + ' data-column="' + header + '"><label for="chb-' + measure + '">' + header.replace(lib_type + ' ', '') + '</label></div>'
                    );
                }
            });
